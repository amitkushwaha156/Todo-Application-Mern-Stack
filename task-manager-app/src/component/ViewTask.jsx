  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-center items-center bg-gray-800 bg-opacity-75">
      <div className="bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 dark:text-white rounded-lg shadow-lg p-6 w-96">
        <h2 className="text-2xl dark:text-gray-300 font-semibold mb-4">Task Details</h2>
        ...
        <div className="space-y-4">
          ...
          <p className="text-lg">
            <strong className="text-gray-800 dark:text-gray-300">Description:</strong>{" "}
            <span className="text-gray-700 dark:text-gray-400">{task.description}</span>
          </p>

          <p className="text-lg">
            <strong className="text-gray-800 dark:text-gray-300">Due Date:</strong>{" "}
